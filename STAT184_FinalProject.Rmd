...
ggplot(
  ...
  #assign the points a shape and color and add a line of best fit
  ...
  theme_minimal() 
  #fix the x axis scaling
  scale_x_continuous(breaks = seq(0,150, by = 15), limits = c(0,150), expand = c(0, 0))

```

hello welcome back to another minecraft lets play video
