...
#rename columns 
colnames(TimeSleep)<- c('Index','Year','Period','AverageHoursPerDaySleeping','Standard Error','Type of Days','AgeGroup','Activity','Sex')
...
ggplot(
  data = HoursByAge,
  mapping = aes(x = AgeGroup, weight = Mean)
) +
  ...
  theme(axis.line.x = element_line(color="black", linewidth = .25),
        axis.line.y = element_line(color="black", linewidth = .25)
  ) +
